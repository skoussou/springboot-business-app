...
5. Change the service name according to the `artifact-id` in your `pom.xml` in https://github.com/skoussou/springboot-business-app/blob/master/src/main/fabric8/service.yml[`service.yml`] 
